...
<meta name="description" content="EAGLES Basketball Academy: akademi basket privat di Jakarta Selatan. Program U12, U16, dan Tim Elite bersama pelatih bersertifikasi FIBA.">
...
<header class="nav">
  <div class="container nav__inner">
    <a class="brand" href="{{ route('landing') }}" aria-label="EAGLES Academy — Beranda">
      <img src="{{ asset('assets/images/logoEAGLES.jpeg') }}" alt="EAGLES Logo" width="34" height="34" style="object-fit: cover; border-radius: 50%;">
    ...
    @auth
      <div style="display: flex; align-items: center; gap: 10px;">
        <a href="{{ route('admin.registrations') }}" style="font-size: 12px; font-weight: 800; color: #002068; background: #f0f4ff; border: 1px solid #c3dafe; padding: 6px 12px; border-radius: 20px; text-decoration: none;">
          🟢 Admin: {{ Auth::user()->name }}
        </a>
        <form action="{{ route('logout') }}" method="POST" style="margin: 0;">
          @csrf
          <button type="submit" style="background: #e53e3e; color: #fff; border: none; padding: 7px 14px; border-radius: 6px; font-weight: 700; font-size: 12px; cursor: pointer;">Logout</button>
        </form>
      </div>
    @else
      ...
      <div class="grid grid--3">
        <article class="card feature">
          <span class="feature__ico" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M8 21h8M12 17v4M7 4h10v5a5 5 0 01-10 0V4z"/><path d="M17 5h3v2a3 3 0 01-3 3M7 5H4v2a3 3 0 003 3"/></svg>
          </span>
        ...
        <article class="card feature">
          <span class="feature__ico" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 20V10M9 20V4M15 20v-8M21 20V7"/></svg>
          </span>
        ...
        <article class="card feature">
          <span class="feature__ico" aria-hidden="true">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3c3 3 3 15 0 18M12 3C9 6 9 18 12 21"/></svg>
          </span>
          <h3>Siap Kejuaraan</h3>
          <p>Rutin mengikuti turnamen lokal dan nasional, lengkap dengan sesi pemantauan bakat dan evaluasi pemain.</p>
        </article>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container text-center">
      ...
      <p class="lead" style="max-width:52ch;margin:14px auto 26px">
        Isi formulir registrasi pemain baru. Data dan foto kamu akan otomatis masuk ke daftar pemain sesuai kelompok umur.
      </p>
...
<div class="ai-widget">
  <div class="ai-chat-card hidden" id="aiPanel">
    ...
    <div class="ai-chat-body" id="chatBody">
      <div class="chat-msg bot">
        <div class="bot-icon">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="4" y="7" width="16" height="12" rx="3"/><path d="M12 3v4M9 12h.01M15 12h.01M9.5 16h5"/></svg>
        </div>
    ...
    <div class="ai-suggestions">
      ...
      <button class="chip-btn" type="button" onclick="sendQuickMsg('Dimana Lokasi Latihan?')">Dimana Lokasi Latihan?</button>
      <button class="chip-btn" type="button" onclick="sendQuickMsg('Bagaimana cara bergabung?')">Bagaimana cara bergabung?</button>
    </div>
  ...
  <button class="ai-fab" id="aiFab" type="button" aria-label="Buka Pelatih AI">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="4" y="7" width="16" height="12" rx="3"/><path d="M12 3v4M9 12h.01M15 12h.01M9.5 16h5"/></svg>
  </button>
</div>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    aiMinimizeBtn.addEventListener('click', toggleChat);
  });
  ...
  function handleSend(e) {
    ...
    if (text) {
      ...
      setTimeout(() => {
        appendBotMsg("Terima kasih! Pertanyaanmu telah kami terima. Tim admin kami juga bisa dihubungi langsung via WhatsApp jika butuh respon cepat.");
      }, 800);
    }
  }
  ...
  function sendQuickMsg(text) {
    appendUserMsg(text);
    setTimeout(() => {
      appendBotMsg("Informasi mengenai '" + text + "' bisa ditanyakan langsung ke admin kami atau cek halaman Jadwal & Kontak di menu atas.");
    }, 800);
  }
